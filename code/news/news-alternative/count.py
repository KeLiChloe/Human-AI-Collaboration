...
CORE = "news-alternative"

START_YEAR = 1980
END_YEAR = 2025

DIR = f"/Users/like/Desktop/Research/Human-AI/code/news/{CORE}/"
...
def count_for_year(session, year, term):
    ...
    """
    q_clause = f'(title_t:"{term}") OR (description_t:"{term}")'
    params = {
        "q": q_clause,
        "fq": f"year_i:{year}",
        "rows": 0,
...
# 保存结果
with open(DIR+"category_counts_yearly.json", "w") as f:
