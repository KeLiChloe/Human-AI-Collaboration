"""
Code Q Gender.13 post-ML diagrams into structure metrics.

Writes columns in-place into All_Participants_All_Questions.csv:
  - Q Gender.13 Number of paths
  - Q Gender.13 Maximum path length
  - Q Gender.13 Number of latent variables
  - Q Gender.13 Coding reasoning
...
TARGET_COLUMN = "Q Gender.13 post-ML diagram (main effects)"
METRIC_COLUMNS = [
    "Q Gender.13 Number of paths",
    "Q Gender.13 Maximum path length",
    "Q Gender.13 Number of latent variables",
...
def main() -> None:
    run_diagram_coding(
        ...
        outcome="gender",
        progress_desc="Q Gender.13 diagram coding",
    )
