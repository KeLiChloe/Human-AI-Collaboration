...
DEFAULT_INPUT_CSV = SCRIPT_DIR.parents[2] / "All_Participants_All_Questions.csv"
DEFAULT_OUTPUT_ROOT = SCRIPT_DIR / "embeddings_openai"

NAME_COLUMN = "What is your full name?"
TYPE_COLUMN = "student_0, expert_1, genAI_2"
...
def run_one_job(
    ...
    participant_names = df[name_col].apply(clean_text).tolist()
    participant_types = [
