...
This data package contains the data that powers the chart ["GDP per capita"](https://ourworldindata.org/grapher/gdp-per-capita-maddison?tab=table&time=2010..latest&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
